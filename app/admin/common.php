...
function contents($user_name,$title,$body,$link,$user_comment)
{
    ...
    <div style="width: 570px; margin: 0 auto; background: #fff; padding: 25px 70px; border-top: 30px solid #1abc9c;">
        <div style="text-align: center; margin-bottom: 40px; line-height: 1.8em;">
            <h1 style="color: #333;">刘海 | LH-Blog</h1></div>
        <p style="font-size: 18px; color: #333;">'.$user_name.'，您好！</p>您曾在《
        <a target="_blank" href="' .$link. '">'.$title.'</a>》上发表评论:
        <br />&nbsp;&nbsp;&nbsp;&nbsp;
        <p style="border: 1px solid #eee; padding: 20px; margin: 15px 0;">"'.$user_comment.'"</p>
        <span>Hai 给您的回应：</span>
        <br />&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <p class="footer" style="border-top: 1px solid #DDDDDD; padding-top: 6px; margin-top: 15px; color: #838383; text-align: center;">你可以点击此链接
            ...
            <a href="http://liuhai.fun.">刘海 の 博客</a>
        </p>
        <a style="display: block; width: 400px; height: 40px; background: #1abc9c; margin: 25px auto 40px; font-size: 16px; line-height: 40px; letter-spacing: 3px; color: #f8f8f8; text-align: center; text-decoration: none;" href="http://liuhai.fun." target="_blank">发现更多精彩&gt;&gt;</a>
        <p style="text-align: center;color: #bbb;margin-top: 40px;">「刘海 | LH-Blog」 '.date('Y').'年 by Copyright.</p></div>
</div>';
}
