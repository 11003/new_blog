...
class Article extends Model
{
    public function keyselect($key)
    {
        ...
        $filed = "a.*,c.catename";
        $res = $this->alias('a')->field($filed)->order('create_time desc')->join($join)->where('title','LIKE','%'.$key.'%')->paginate(10);
        return $res;
    }
    public function selects()
    {
        ...
        $filed = "a.*,c.catename";
        $res = $this->alias('a')->field($filed)->order('create_time desc')->join($join)->paginate(10);
        return $res;
    }
